...
class Base{
	...
	private function createTempEngine(){
        ...
        $T->template_dir = '.'.DS.'htmls'.DS.'home'.DS.'templates'.DS;
		$T->config_dir = '.'.DS.'htmls'.DS.'home'.DS.'configs'.DS;
		$T->compile_dir = '.'.DS.'htmls'.DS.'home'.DS.'templates_c'.DS;
		$T->cache_dir = '.'.DS.'htmls'.DS.'home'.DS.'cache'.DS;
		...
		$T->assign('__THEME__',__THEME__.'/home');
